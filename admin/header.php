...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <header class="main-header">
      <a href="index.php" class="logo">
        <span class="logo-mini"><b>E-</b>GALLERY PROYEK SISWA</span>
        <span class="logo-lg"><b>E-GALLERY</b>PROSIS</span>
      </a>
  ...
  <ul class="dropdown-menu">
    <!-- Menu-item untuk profil -->
    <li class="user-header">
      <?php if ($profil['admin_foto'] == "") { ?>
        <img src="../gambar/sistem/user.png" class="img-circle" alt="User Image">
      <?php } else { ?>
        <img src="../gambar/user/<?php echo $profil['admin_foto'] ?>" class="img-circle" alt="User Image">
      <?php } ?>
      <p>
        <?php echo $_SESSION['nama']; ?> - Admin
        <small>Member since <?php echo date("M. Y", strtotime($profil['admin_tanggal'])); ?></small>
      </p>
    </li>
