...
<div class="table-responsive">
    <table class="table table-bordered table-striped" id="table-datatable">
        ...
        <tbody>
            <?php 
            $no = 1;
            $invoice = mysqli_query($koneksi, "SELECT invoice.*, customer.customer_nama, produk.produk_nama 
                                               FROM invoice 
                                               INNER JOIN customer ON customer.customer_id = invoice.invoice_customer 
